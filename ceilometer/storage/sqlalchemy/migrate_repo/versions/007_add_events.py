...
event = Table(
    'event', meta,
    Column('id', Integer, primary_key=True),
    Column('when', DateTime, index=True),
...
trait = Table(
    ...
    Column('t_float', Numeric, nullable=True, default=None, index=True),
    Column('t_int', Integer, nullable=True, default=None, index=True),
    Column('t_datetime', Float, nullable=True, default=None, index=True),
