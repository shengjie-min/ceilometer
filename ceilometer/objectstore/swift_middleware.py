...
try:
    ...
    INPUT_PROXY = swift.common.utils
except ImportError:
    # Swift <= 1.7.5
    import swift.common.middleware.proxy_logging
    INPUT_PROXY = swift.common.middleware.proxy_logging
...
class CeilometerMiddleware(object):
    ...
    def __call__(self, env, start_response):
        ...
        input_proxy = INPUT_PROXY.InputProxy(env['wsgi.input'])
